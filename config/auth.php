...
return [
    ...
    | opciones de restablecimiento de contraseña para su aplicación. Puede cambiar
    | estos valores predeterminados según sea necesario, pero son un punto de
    | partida perfecto para la mayoría de las aplicaciones.
    |
    */
    ...
    | aquí que utiliza el almacenamiento de sesión y el proveedor de usuario Eloquent.
    |
