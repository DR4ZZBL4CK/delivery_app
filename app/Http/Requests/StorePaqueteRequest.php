...
class StorePaqueteRequest extends FormRequest
{
    ...
    {
        return [
            'camioneros_id' => ['required', 'integer', 'exists:camioneros,id'],
            'estados_paquetes_id' => ['required', 'integer', 'exists:estados_paquetes,id'],
            'direccion' => ['required', 'string', 'max:25', 'min:5'],
